...
const resources = {
  ...
  ja: {
    translation: {
      ...
      features: { title: '機能', list: [{ title: 'KDE Plasma デスクトップ', desc: 'S3RLテーマのKDE Plasma、カスタムウィジェット、リシンぐパラダイス' }, { title: 'ネオンターミナル', desc: 'Zsh + powerlevel10k、S3RLテーマ、カスタムエイリアス' }, { title: 'pearOS統合', desc: '最新のpearOSアプリとユーティリティ、シームレス統合' }, { title: 'AURサポート', desc: 'AUR完全アクセス + カスタムS3RLリポジトリ' }] },
  ...
  de: {
    translation: {
      ...
      features: { title: 'FEATURES', list: [{ title: 'KDE Plasma Desktop', desc: 'S3RL-themed KDE Plasma mit benutzerdefinierten Widgets, Ricing-Paradies' }, { title: 'Neon Terminal', desc: 'Zsh mit powerlevel10k, S3RL Theme, benutzerdefinierte Aliases' }, { title: 'pearOS Integration', desc: 'Neueste pearOS Apps und Utilities, nahtlose Integration' }, { title: 'AUR Support', desc: 'Voller Zugriff auf AUR mit S3RL Paket-Repository' }] },
  ...
  fr: {
    translation: {
      ...
      features: { title: 'FONCTIONNALITÉS', list: [{ title: 'Bureau KDE Plasma', desc: 'KDE Plasma theme S3RL avec widgets personnalises, paradis du ricing' }, { title: 'Terminal Neon', desc: 'Zsh avec powerlevel10k, theme S3RL, aliases personnalises' }, { title: 'Integration pearOS', desc: 'Dernieres apps et utilitaires pearOS, integration transparente' }, { title: 'Support AUR', desc: 'Acces complet a AUR avec depot de paquets S3RL' }] },
